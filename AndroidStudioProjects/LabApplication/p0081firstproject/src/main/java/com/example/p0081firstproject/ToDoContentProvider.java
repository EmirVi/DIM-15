...
public class ToDoContentProvider extends ContentProvider {
    ...
    private static final String AUTHORITY = "com.example.p0081firstproject.contentprovider";
        ...
        switch (uriType) {
            ...
            case TODO_ID:
                ...
                if (TextUtils.isEmpty(selection)) {
                    ...
                    rowsUpdated = sqlDB.update("todos", values, "_id =" + id + " and " + selection, selectionArgs);
                }
                break;
            default:
                throw new IllegalArgumentException("Unknown URI: " + uri);
